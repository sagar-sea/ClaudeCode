...
analysis_ws['A{row_num + 2}'.format(row_num=row_num)] = 'Last Name Frequencies'
analysis_ws['A{row_num + 3}'.format(row_num=row_num)] = 'LastName'
analysis_ws['B{row_num + 3}'.format(row_num=row_num)] = 'Count'
